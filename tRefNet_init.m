...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(1,9,1, 512, 'single'), zeros(1, 32, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(1,9,32, 256, 'single'), zeros(1, 8, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(1,9,1, 128, 'single'), zeros(1, 32, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(1,9,32, 64, 'single'), zeros(1, 8, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(1,9,1, 32, 'single'), zeros(1, 32, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(1,9,32, 8, 'single'), zeros(1, 8, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(msize,nwin,8, msize *  nwin, 'single'),zeros(1,msize *  nwin ,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
